...
Suite* one_conversion_specification(void) {
  ...
  // tcase_add_test(ifanateof_tc,
  // unknown_conversion_type_char_in_flag_position);
  ...
  // tcase_add_test(ifanateof_tc,
  // conversion_lacks_type_at_the_middle_of_format);
...
Suite* two_or_more_conversion_specifications(void) {
  ...
  // tcase_add_test(
  //     pt_tc,
  //     conversion_lacks_type_at_end_of_format_with_format_error_before);
  suite_add_tcase(wcs_s, pt_tc);
